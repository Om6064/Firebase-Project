                    ...
                    <div className="w-full md:w-7/12 p-6 md:p-10 text-2xl md:text-4xl bg-white text-[#232323]">
                        ...
                        <form className="w-full max-w-md my-10 md:my-20" onSubmit={handleSignUp}>
                            <div className="relative z-0 w-full mb-5 group my-8 md:my-12">
                                <input type="email" name="floating_email" id="email" value={input.email} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " onChange={handleChange} required />
