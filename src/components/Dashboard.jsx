...
const Dashboard = () => {
  ...
  return (
    <section className="bg-[url('/Background.png')] min-h-screen bg-no-repeat bg-cover bg-center p-4">
      <div className="container mx-auto">
        <div className="relative top-28">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            ...
            <Link
              to={"/addproduct"}
              className="bg-[#00c38b] py-2 px-4 rounded-xl text-white font-semibold shadow-md text-center"
            >
              + Add Product
            </Link>
          </div>
          ...
          {products.length > 0 ? (
            <div className="overflow-x-auto mt-6 rounded-xl shadow-md bg-white">
                ...
                <tbody>
                  {products.map((product) => (
                    ...
                    >
                      <th
                        scope="row"
                        className="px-4 sm:px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-sm"
                      >
                        {product.name}
                      </th>
            ...
            <div className="flex flex-col items-center justify-center bg-white/70 rounded-xl shadow-md py-12 px-4 sm:py-16 sm:px-6 mt-8 text-center">
              <svg
              ...
              <Link
                to="/addproduct"
                className="bg-[#00c38b] text-white px-4 sm:px-6 py-2 rounded-lg shadow hover:bg-[#00a877] transition text-sm sm:text-base"
              >
